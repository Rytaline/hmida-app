...
SOURCES : appuie-toi sur la bibliothèque (sources réelles fournies) ET sur la RECHERCHE WEB dont tu disposes. Utilise la recherche web SYSTÉMATIQUEMENT en mode Veille (trouver les publications récentes — articles, vidéos, posts — sur OCP/UM6P/cadmium/uranium/hydrogène/phosphate, des derniers jours/semaines) et dès qu'un fait ou un chiffre récent doit être vérifié. Privilégie les sources primaires et datées. Cite toujours les URLs trouvées dans le corps.
